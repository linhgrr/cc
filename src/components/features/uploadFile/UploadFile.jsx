...
const UploadFile = () => {
  ...
  const uploadFile = async (fileToUpload) => {
    ...
    const allowedFormats = ["pdf", "docx", "xlsx", "pptx", "ppt"];

    if (!ext || !allowedFormats.includes(ext)) {
      notification.error({
        message: "Invalid Format",
        description: "Only PDF, DOCX, XLSX, PPTX, and PPT are supported.",
      });
      return;
    }
  ...
  const handleTranslateClick = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        origin_language: selectedOriginLanguage === "Origin Language" ? null : LANGUAGE_CODES[selectedOriginLanguage],
